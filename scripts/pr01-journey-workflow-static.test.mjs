...
assert.match(workflow, /Journey A preflight and fresh zero-to-50 rebuild/);
assert.match(workflow, /Journey B preflight and exact 25-to-50 upgrade/);
assert.match(
  workflow,
  /BLUNDR_EXPECTED_MIGRATION_COUNT=50 BLUNDR_EXPECTED_MIGRATION_HEAD=20260918130000/,
);
...
assertInOrder(
  "Journey A preflight and fresh zero-to-50 rebuild",
...
assertInOrder(
  "Journey B preflight and exact 25-to-50 upgrade",
