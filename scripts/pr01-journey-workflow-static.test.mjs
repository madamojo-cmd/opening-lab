...
assert.match(workflow, /Journey A preflight and fresh zero-to-48 rebuild/);
assert.match(workflow, /Journey B preflight and exact 25-to-48 upgrade/);
assert.match(
  workflow,
  /BLUNDR_EXPECTED_MIGRATION_COUNT=48 BLUNDR_EXPECTED_MIGRATION_HEAD=20260912120000/,
);
...
assertInOrder(
  "Journey A preflight and fresh zero-to-48 rebuild",
...
assertInOrder(
  "Journey B preflight and exact 25-to-48 upgrade",
