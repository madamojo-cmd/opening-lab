...
export function ReviewQueueInbox() {
  ...
  return (
    <div className="mt-4 flex min-h-0 flex-1 flex-col gap-3">
      <div className="flex flex-wrap items-center justify-between gap-2 bg-white/95 pb-2">
      ...
      {isUnavailable ? (
        ...
        <div
          className="grid min-h-0 gap-2 overflow-visible pr-0 min-[821px]:flex-1 min-[821px]:overflow-y-auto min-[821px]:pr-1"
