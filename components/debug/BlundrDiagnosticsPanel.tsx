...
export function buildDebugCopyEverythingPayload(snapshot: TrainerDebugSnapshot | null | undefined): Record<string, unknown> {
  return {
    ...
    runtime: {
      ...
      lineSelectionBlockedThirdRepeatLineKeys: (snapshot as any)?.runtime?.lineSelectionBlockedThirdRepeatLineKeys ?? [],
      lineSelectionSelectedLineKey: (snapshot as any)?.runtime?.lineSelectionSelectedLineKey ?? null,
      lineSelectionPreviousTwoSame: (snapshot as any)?.runtime?.lineSelectionPreviousTwoSame ?? null,
      lineSelectionSessionId: (snapshot as any)?.runtime?.lineSelectionSessionId ?? null,
      lineSelectionVariationReason: (snapshot as any)?.runtime?.lineSelectionVariationReason ?? null,
      lineSelectionRepeatUnavoidable: (snapshot as any)?.runtime?.lineSelectionRepeatUnavoidable ?? null,
      ...
      selectedRuntimeLinePlyLength: (snapshot as any)?.runtime?.selectedRuntimeLinePlyLength ?? null,
      selectedRuntimeLineCurrentPly: (snapshot as any)?.runtime?.selectedRuntimeLineCurrentPly ?? null,
      selectedRuntimeLineExhausted: (snapshot as any)?.runtime?.selectedRuntimeLineExhausted ?? null,
      terminalProofLineAuthority: (snapshot as any)?.runtime?.terminalProofLineAuthority ?? null,
      terminalProofBlockedReason: (snapshot as any)?.runtime?.terminalProofBlockedReason ?? null,
