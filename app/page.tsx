...
export function BlundrApp({ initialTab = "home", initialOpeningId = null }: { initialTab?: Tab; initialOpeningId?: string | null }){
...
export default function App(){
  return <BlundrApp initialTab="home" />;
}
