...
export function testRuntimeDataSourceDebug(): void {
  ...
  assert.equal((snapshot as any).runtime.runtimePackageId, "blundr-opening-runtime-3.99.v2");
  ...
  assert.equal((copyEverything as any).runtime.runtimePackageId, "blundr-opening-runtime-3.99.v2");
