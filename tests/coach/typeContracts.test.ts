...
export function testTypeContracts(): void {
  ...
  const compiledFrame: CompiledCoachFrame = {
    ...
    primaryConcept: null,
    secondaryConcepts: [],
    evidenceUsed: ["claim_1"],
    plain: {
      hint: "Fight for the center with your pawn.",
      showMoreAvailable: true,
      leakRisk: "low",
    },
    assisted: {
      title: "Center Control",
      body: "This move gains space and supports development.",
    },
    showMore: {
      title: "Why This Matters",
      body: "Central control improves flexibility for your pieces.",
    },
    visualIntents: [
      {
        id: "intent_1",
