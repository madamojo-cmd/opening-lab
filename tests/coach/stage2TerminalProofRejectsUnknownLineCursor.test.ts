...
export function testStage2TerminalProofRejectsUnknownLineCursor(): void {
  ...
  assert.equal(proof.blockedReasons.includes("selected_line_cursor_unknown"), true);
}

testStage2TerminalProofRejectsUnknownLineCursor();
console.log("stage2TerminalProofRejectsUnknownLineCursor ok");
