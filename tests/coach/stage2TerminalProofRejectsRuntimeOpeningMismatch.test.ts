...
export function testStage2TerminalProofRejectsRuntimeOpeningMismatch(): void {
  const proof = resolveStage2TerminalProof({
    ...
    runtimeOpeningId: "italian-white",
  ...
  assert.equal(proof.blockedReasons.includes("runtime_opening_mismatch"), true);
}

testStage2TerminalProofRejectsRuntimeOpeningMismatch();
console.log("stage2TerminalProofRejectsRuntimeOpeningMismatch ok");
