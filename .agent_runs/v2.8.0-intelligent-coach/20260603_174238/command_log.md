# Package 11 Command Log

Run dir: .agent_runs/v2.8.0-intelligent-coach/20260603_174238
...
-----
[1m[31mFATAL[39m[0m: An unexpected Turbopack error occurred. A panic log has been written to /tmp/next-panic-958a6cc467bb93379f8e1d41abe93301.log.
...
✓ Generating static pages using 1 worker (3/3) in 433ms
...
## Manual dev smoke (start + curl + log scan)
dev_manual_retry_start
dev_pid=80
http_code=000
...
[?25h
/bin/bash: line 11: kill: (80) - No such process
dev_manual_retry_end

## Manual dev smoke (escalated retry)
dev_pid=229700
http_code=200
...
Creating turbopack project { dir: '/workspaces/opening-lab', testMode: true }
 ...
 GET / 200 in 676ms (next.js: 219ms, application-code: 458ms)
