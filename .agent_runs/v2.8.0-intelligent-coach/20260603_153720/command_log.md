# Package 10.5B Command Log

- Timestamp: 2026-06-03T15:37:30Z
...
-----
[1m[31mFATAL[39m[0m: An unexpected Turbopack error occurred. A panic log has been written to /tmp/next-panic-ff31cbc6299f98410fda6d13823f4fba.log.
...
./app/page.tsx:2273:5
Type error: Block-scoped variable 'surfaceCoachCardDecision' used before its declaration.

  [90m2271 |[0m     presentationFrame.coach.body,
  [90m2272 |[0m     presentationFrame.coach.buttons,
[31m[1m>[0m [90m2273 |[0m     surfaceCoachCardDecision?.shouldShowCoachCard,
  [90m     |[0m     [31m[1m^[0m
  [90m2274 |[0m     surfaceCoachCardDecision?.title,
  [90m2275 |[0m     surfaceCoachCardDecision?.body,
  [90m2276 |[0m     surfaceCoachCardDecision?.buttons,
...
✓ Generating static pages using 1 worker (3/3) in 430ms
