...
export const seo = {
  ...
  "/pricing": ["Blundr Pricing | Free and Pro Chess Training", "Start with useful free chess training or unlock complete personalization, unlimited review, all openings, Chess.com and Lichess connections, premium Daily activity, and three focused minigames with Blundr Pro."],
