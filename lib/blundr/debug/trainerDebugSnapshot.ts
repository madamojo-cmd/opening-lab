...
export function buildTrainerDebugSnapshot(input: Record<string, any>): TrainerDebugSnapshot {
  ...
  const snapshot: TrainerDebugSnapshot = {
    ...
    continuation: {
      ...
      runtimeBookPlayKeyBefore: input.runtimeBookPlayKeyBefore ?? null,
      runtimeBookStatus: input.runtimeBookStatus ?? null,
      runtimeBookCandidateCount: Number(input.runtimeBookCandidateCount ?? 0),
      runtimeBookTopCandidateUci: input.runtimeBookTopCandidateUci ?? null,
      ...
      opponentReplyAuthorityCandidateUci: input.opponentReplyAuthorityCandidateUci ?? null,
    ...
    runtime: {
      ...
      selectedRuntimeLineKey: input.selectedRuntimeLineKey ?? null,
